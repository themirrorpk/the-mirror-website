...
<Container>
  <Row md={4} >
    <Col> <div>
          ...
          <div>
            <text className="contact">Self defense training and online sessions with Pretty Deadly </text>{" "}
          </div>
          </Col>
    <Col xs={6}>
    <div >
          ...
          <div>
            <text className="contact">BGSP - Successful group therapy sessions with 25 women </text>{" "}
          </div>
      </Col>
    <Col>
    <div>
          ...
          <div>
            <text className="contact"> #MaiMazboot Campaign with Mind Matters, 2 Art Therapy Events, 2 Successful social Internships</text>{" "}
          </div>
    </Col>
  </Row>
</Container>
...
<Container class="row text-center">
  <Row md={4}>
    <Col> <div>
          ...
          <div>
            <text className="contact">Project Hayat: 2 successful cases so far
 </text>{" "}
          </div>
          </Col>
    <Col xs={6}>
    <div >
          ...
          <div>
            <text className="contact">Pro Bono Legal Aid (In development), Harassment Hotline (In development)</text>{" "}
          </div>
      </Col>
    <Col>
    <div>
          ...
          <div>
            <text className="contact"> Aurat Beyond the Bar, Video Campaigns, School Awareness sessions, Consent Education Curriculum (In development) </text>{" "}
          </div>
    </Col>
  </Row>
</Container>
